...
exports.Scraper = exports.Element = exports.html5Elements = exports.Stack = exports.document = exports.window = void 0;
...
var Element = /** @class */ (function () {
    function Element(name, id, classes, text, attrs, children) {
        this.attributes = {};
        try {
            this.name = name;
            this.id = id;
